...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! You have been attacked by a seamonster."
        static let ComputerHitMonster = "The computer has hit a sea monster! The computer is being attacked by a seamonster."
